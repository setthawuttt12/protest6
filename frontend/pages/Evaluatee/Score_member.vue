            ...
            <v-col cols="12">
                <v-form v-if="user.status_eva === 2 || user.status_eva === 3">
                        ...
                        <v-col cols="12">
                            ...
                            <v-table class="table">
                                ...
                                <tr v-for="(indicate,i) in topic.indicates" :key="indicate.id_indicate">
                                    ...
                                    <td class="border pa-1 text-center" style="width: 10%;"><v-btn color="blue" size="small" v-if="indicate.file_eva" @ckick="viwefile(indicate.file_eva)">เปิดดู</v-btn></td>
                    ...
                    <div class="text-center mt-4">
                        <v-card class="pa-2 text-end" color="success">คะแนนรวม : {{ user.total_eva }} คะแนนที่ได้</v-card>
                    </div>
                </v-form>
